...
- [x] **P1-03** Forced password change on first login. · verified 2026-04-19
  - AC: Seeded super admin cannot use the app until they change from `Demo1234`. `forcePasswordChange` flag enforced in auth config.
  - DoD: Universal, B.
...
- [x] **P4-05** REST API + API keys for other Demo internal tools to call the generator. · verified 2026-04-19
