      ...
      {showInvite && (
        ...
        >
          ...
          <form onSubmit={handleSubmit(onInvite)} className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            <div>
              <input {...register("email")} type="email" placeholder="email@example.com" className="w-full px-3 py-2 rounded-[var(--radius-md)] border border-[var(--color-border)] text-body-ui" />
